...
def main():
    ...
    roleLM = Role(name='LineManager', priority=50)
    roleLM.save()
    roleLM = Role(name='ShiftLeader', priority=10)
    roleLM.save()
    roleLM = Role(name='TS2ShiftLeader', priority=10)
    roleLM.save()
    roleLM = Role(name='Operator', priority=30)
    roleLM.save()
    roleLM = Role(name='SystemExpert')
    roleLM.save()
