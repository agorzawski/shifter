...
def create_basics(apps, schema_editor):
        ...
        slot.save()
        slot = Slot(name='Afternoon', hour_start=datetime.time(12, 30, 0), hour_end=datetime.time(16, 30, 0), abbreviation='PM', color_in_calendar='#999999', op=True)
        slot.save()
        ...
        slot.save()
        slot = Slot(name='Evening', hour_start=datetime.time(14, 0, 0), hour_end=datetime.time(22, 00, 00), abbreviation='EV', color_in_calendar='#4E779A')
        slot.save()
        ...
        slot.save()
        slot = Slot(name='OnCall', hour_start=datetime.time(8,0,0), hour_end=datetime.time(16,30,0), abbreviation='OC', color_in_calendar='#47844D')
        slot.save()
        slot = Slot(name='Linac Evening Shift', hour_start=datetime.time(15,30,0), hour_end=datetime.time(23,30,0), abbreviation='LES', color_in_calendar='#999999')
        slot.save()
        slot = Slot(name='Linac Morning Shift', hour_start=datetime.time(7,30,0), hour_end=datetime.time(15,30,0), abbreviation='LMS', color_in_calendar='#47844D')
        slot.save()
